                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" style="text-transform: uppercase;" placeholder="Surname" name="lastname" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>"><input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" style="text-transform: uppercase;"  placeholder="First Name" name="firstname" required>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" style="text-transform: uppercase;"  placeholder="Other Names" name="othernames" >
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Email <span class="text-danger">*</span></label>
                                        <input class="form-control" type="email" style="text-transform: lowercase;"  placeholder="Email" name="email" >
                                    </div>
                                </div>
       ...
       @endforeach
                                ...
                                <div class="col-sm-6">
									<div class="form-group gender-select">
										...
										<div class="form-check-inline">
											<label class="form-check-label">
												<input style="text-transform: uppercase;" type="radio" id="gender" name="gender" value="male" class="form-check-input" required>Male
											</label>
										</div>
										<div class="form-check-inline">
											<label class="form-check-label">
												<input style="text-transform: uppercase;" type="radio" id="gender" name="gender" value="female" class="form-check-input" required>Female
											</label>
										</div>
									...
									<div class="form-group gender-select">
										...
										<div class="form-check-inline">
											<label class="form-check-label">
												<input style="text-transform: uppercase;" type="radio" id="marital_status" name="marital_status" value="single" class="form-check-input" reuired>Single
											</label>
										</div>
										<div class="form-check-inline">
											<label class="form-check-label">
												<input style="text-transform: uppercase;" type="radio" id="marital_status" name="marital_status" value="married" class="form-check-input" required>Married
											</label>
										</div>
