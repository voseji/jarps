                    ...
                    <form method="POST" action="/create-batch">
                        ...
                        <input name="created_by" type="hidden" value="{{ Auth::user()->name }}"/>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                    <input id="batch_number" type="text" class="form-control" name="batch_number"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                    <input id="batch_date" type="date" class="form-control" name="batch_date"  required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input id="batch_time" type="text" class="form-control" name="batch_time" required>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                    <input id="seats_available" type="number" class="form-control" name="seats_available" required>
                                    </div>
                                </div>
